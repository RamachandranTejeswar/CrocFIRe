...
module user_domain import user_pkg::*; import croc_pkg::*; #(
  ...
  assign interrupts_o[0] = fir_done;
...
//-------------------------------------------------------------------------------------------------
  ...
  user_fir_acc #(
    ...
    .clk_i         ( clk_i               ),
    .rst_ni        ( rst_ni              ),
    .obi_cfg_req_i ( user_design_obi_req ),
    .obi_cfg_rsp_o ( user_design_obi_rsp ),
    .obi_mem_req_o ( user_mgr_obi_req_o  ),
    .obi_mem_rsp_i ( user_mgr_obi_rsp_i  ),
    .done_o        ( fir_done            )
  );
